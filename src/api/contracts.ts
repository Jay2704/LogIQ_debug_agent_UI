...
export interface JiraService {
  ...
  /** GET /api/v1/jira/tickets/{ticket_key}?workspace_id=… — full ticket for RCA intake. */
  getTicketSummary(ticketKey: string, workspaceId: string): Promise<JiraTicketSummary>;
