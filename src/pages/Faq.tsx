...
export function Faq() {
  return (
    <div className="mx-auto max-w-3xl space-y-8 pb-8">
      <section className="hero-glow-panel relative overflow-hidden rounded-2xl border border-blue-500/15 bg-gradient-to-br from-black/[0.85] via-[#0a1020] to-black/[0.96] p-6 shadow-[0_0_0_1px_rgba(59,130,246,0.1),0_24px_64px_-32px_rgba(0,0,0,0.55)] sm:p-8">
        ...
        <div className="relative z-10 text-center">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            <Link
              to="/about"
              className={cn(
                "inline-flex items-center justify-center rounded-xl border border-white/[0.12] bg-black/[0.82] px-5 py-2.5 text-sm font-semibold text-slate-200 transition hover:border-sky-500/30 hover:bg-black/[0.82] hover:text-white",
